...
public class SendDumpFragment extends BaseFragment  {
	...
	public void emailMiniDumps()
	{
		...
		uris.add(Uri.parse("content://cn.edu.bupt.niclab.FileProvider/" + ldump.getName()));
		uris.add(Uri.parse("content://cn.edu.bupt.niclab.FileProvider/" + ldump.getName() + ".log"));
